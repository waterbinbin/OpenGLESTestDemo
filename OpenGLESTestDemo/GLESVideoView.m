...
- (BOOL)loadShaders
{
    ...
    vertShaderURL = [[NSBundle mainBundle] URLForResource:@"vertexShaderVideo" withExtension:@"vsh"];
    ...
    fragShaderURL = [[NSBundle mainBundle] URLForResource:@"fragmentShaderVideo" withExtension:@"fsh"];
